...
// let pausebutton = document.querySelector('#my-button')
...
//         },1000)}
    ...
    const showlist = document.querySelector(".rules");

showlist.addEventListener("click",function showText() { 
    element = document.querySelector('.article'); 
    element.style.display = 'flex'; 
});

showlist.addEventListener("dblclick",function hideText() { 
  element = document.querySelector('.article'); 
